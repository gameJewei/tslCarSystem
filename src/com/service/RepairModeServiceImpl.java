...
public class RepairModeServiceImpl implements RepairModeService{
	...
	@Override
	public Result addOrderInfo(String user_id, String user_name, String plate, String trouble_code,String trouble_name,
							   String contact, String contact_way, String remark) {
		// TODO Auto-generated method stub
		RepairMode oi=new RepairMode();
	...
	public Result findAllOrder() {
		// TODO Auto-generated method stub
		List<RepairMode> list=dao.findAllOrder();
	...
	public Result findOrder(String user_id) {
		// TODO Auto-generated method stub
		List<RepairMode> list=dao.findOrder(user_id);
		return new Result("0", "订单信息加载成功", list);
	}
	...
	public Result searchOrderInfo(String type, String keywords) {
		...
		List<RepairMode> list=dao.searchOrderInfo(params);
		return new Result("0", "订单信息加载成功", list);
	}
	...
	public Result findDealOrder() {
		// TODO Auto-generated method stub
		List<RepairMode> list=dao.findByStatus(1);
		return new Result("0", "订单信息加载成功", list);
	}
	...
	public Result  findUndealOrder() {
		// TODO Auto-generated method stub
		List<RepairMode> list=dao.findByStatus(0);
		return new Result("0", "订单信息加载成功", list);
	}
	...
	public Result findBySort() {
		// TODO Auto-generated method stub
		List<RepairMode> list=dao.findBySort();
		return new Result("0", "订单信息加载成功", list);
	}
